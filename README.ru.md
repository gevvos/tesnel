...
Понять как файлы зависят друг от друга в большом проекте — сложно. IDE показывает импорты одного файла, но не даёт полной картины: какие модули связаны слишком сильно, где прячутся циклические зависимости, как изменение одного файла затронет остальные.
...
Это быстро: **290 файлов за ~400мс**, результат — один самодостаточный HTML.
